...
<head>
    ...
    <title>Bienvenue sur BENU SLO0W</title>
</head>
        ...
        <section class="pattern_bg">
            <div class="central_col">
                <div class="central_textbox">
                    ...
                    <p class="central_textbox__desc">
                        Un premier site web <strong>BENU SLO0W</strong> devrait être mis en ligne fin mai 2022. Tu trouveras ici plus de détails sur le lancement du restaurant BENU SLOOW ! D'ici là, nous t'invitons à visiter notre site principal <a href="https://benu.lu/fr" class="primary-color hover:text-gray-800 transition">www.benu.lu</a>.
                    </p>
                </div>
